<template>
    <div class="order-content">
      ...
      <div class="btn-align">
        <div class="btn-align">
          <el-button  @click="contentShow">未完成</el-button>
          <el-button  @click="contentShow1">已完成</el-button>
        </div>
        <div v-if="!isShow">
          <template>
            <el-table
            ...
            >
              ...
              <el-table-column
                  ...
                  width="80">
                <template slot-scope="scope">
                  <div v-if="scope.row.state=='0'">{{scope.row.content.content_cost}}元</div>
              ...
              <el-table-column
                  ...
                  width="80">
                <template slot-scope="scope">
                  <div v-if="scope.row.state=='0'">购买</div>
